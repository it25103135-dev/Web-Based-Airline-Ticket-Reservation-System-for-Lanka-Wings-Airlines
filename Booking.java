...
public class Booking {
    private int bookingId, flightId;
    private String pnr, passengerName, passportNo, seatNumber, bookingStatus;
    private String flightNo, origin, destination;
    private Timestamp bookedAt, updatedAt, departureTime, arrivalTime;
    ...
    public void setPnr(String v){ pnr=v; }
    public String getPassengerName(){ return passengerName; }
    public void setPassengerName(String v){ passengerName=v; }
    public String getPassportNo(){ return passportNo; }
    public void setPassportNo(String v){ passportNo=v; }
    ...
    public void setFlightNo(String v){ flightNo=v; }
    ...
    public void setFare(BigDecimal v){ fare=v; }
}
